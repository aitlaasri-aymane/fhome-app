...
export default function Plans() {
  return (
    <div>
      ...
      <div className="p-4 max-w-sm bg-white rounded-lg borde hover:shadow-2xl hover:scale-110 transition-all delay-150 duration-500 sm:p-8 dark:bg-gray-800 dark:border-gray-700">
